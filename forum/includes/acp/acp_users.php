	...
	function main($id, $mode)
	{
		...
		switch ($mode)
		{
			...
			case 'profile':
				...
				$data['steam'] = request_var('steam', $user_row['user_steam']);
				$data['youtube'] = request_var('youtube', $user_row['user_youtube']);
				$data['twitch'] = request_var('twitch', $user_row['user_twitch']);
				$data['xbox'] = request_var('xbox', $user_row['user_xbox']);
